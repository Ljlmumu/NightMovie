...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    public void setData(List<ImageView> views, List<VideoInfo> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<ImageView> views, List<VideoInfo> list, ImageCycleViewListener listener, int showPosition) {
    ...
    public static interface ImageCycleViewListener {
         ...
         * @param imageView
         */
        public void onImageClick(VideoInfo info, int postion, View imageView);
    }
}